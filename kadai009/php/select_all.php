...
<fieldset>
<legend><label for="">条件付きで検索</label></legend>
<label for="">会社名：</label><input type="text" name="company_name">
<label for="">職種：</label><input type="text" name="jobstyle">
...
$jobstyle = filter_input( INPUT_POST, "jobstyle" );
